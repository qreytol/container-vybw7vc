...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-vybw7vc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-vybw7vc.containers.anotherwebservice.com/
...
```
git clone git@github.com:qreytol/container-vybw7vc.git
cd container-vybw7vc
```
...
```
docker attach container-vybw7vc
```
